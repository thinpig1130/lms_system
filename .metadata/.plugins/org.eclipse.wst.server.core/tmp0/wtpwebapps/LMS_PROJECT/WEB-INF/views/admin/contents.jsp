	      ...
	      <div class="content">
	        <div class="container-fluid">
		        <form method="post">
				        ...
				        <div class="form-group col-md-4">
					      ...
					      <select id="select_course" name="cocode" class="form-control">
					        ...
					        <c:forEach items="${courses}" var="course">
					        	<option value="${course.code}" ${cur_course.code==course.code?"selected":""}>
					    ...
					    <div class="form-group col-md-4">
					      ...
					      <select id="select_category" name="cacode" class="form-control">
					        ...
					        <c:forEach items="${categorys}" var="category">
					        	<option value="${category.code}" ${cur_category.code==category.code?"selected":""}>
					    ...
					    <div class="form-group col-md-4">
					      ...
					      <select id="select_subcategory" name=subcacode class="form-control">
					        ...
					        <c:forEach items="${sub_categorys}" var="subcategory">
					        	<option value="${subcategory.code}" ${cur_category.code==category.code?"selected":""}>
				    ...
				    <div class="form-group">
				      ...
				      |&nbsp;
						  ...
						  <label class="form-check-label">
						    <input class="form-check-input" type="radio" name="importance" value="1" checked>높음
						    <span class="circle">
						...
						<div class="form-check form-check-radio form-check-inline">
						  <label class="form-check-label">
						    <input class="form-check-input" type="radio" name="importance" value="2"> 중간
						    <span class="circle">
						        <span class="check"></span>
						    </span>
						  </label>
						...
						<div class="form-check form-check-radio form-check-inline disabled">
						  <label class="form-check-label">
						    <input class="form-check-input" type="radio" name="importance" value="3"> 낮음
						    <span class="circle">
						        <span class="check"></span>
						    </span>
						  </label>
					...
					<br>
					<div class="form-group">
	                   	<label class="bmd-label-floating">학습 대표 제목 </label>
