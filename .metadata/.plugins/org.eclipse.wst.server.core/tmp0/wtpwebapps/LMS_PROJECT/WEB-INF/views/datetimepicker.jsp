                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group bmd-form-group">
                          <div class="input-group">
                              ...
                              <input type="password" placeholder="비밀번호 입력" class="form-control">
                          </div>
                      </div>
                    </div>
                  </div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav ml-auto" role="tablist">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="material-icons">face</i>&nbsp;&nbsp; Start
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <div class="section section-basic">
      <div class="container">
        ...
        <ul class="nav nav-pills nav-pills-icons" role="tablist">
          ...
          -->
          <li class="nav-item">
              <a class="nav-link active" href="#newface" role="tab" data-toggle="tab">
                  <i class="material-icons">emoji_people</i>
                  weLEarn
              </a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="#meeting" role="tab" data-toggle="tab">
        ...
        <div class="tab-content tab-space">
          <div class="tab-pane active" id="newface">
            집시(집안지은사람) > 정보를 등록한 사람 : 이주민  > 개인방만든사람 : 토착민 > 비법전수 1회 이상 : 지역유지 > 유명인사 (최근 3개월간 방문자 수 높으면) <br> 
            <br><br>
            자기 자신에 등급에 맞는 정보 출력.
            <br><br>
            최근 가입한 사람의 목록 출력 (최근순)
          </div>
              ...
              <div class="col-md-4">
                  <div class="card">
                      <div class="card-header card-header-primary">
                        <div class="card-icon">
                          <i class="material-icons">groups</i>&nbsp;&nbsp;&nbsp; 세종시 폭풍 공감 모임
                        </div>
                      </div>
                      <div class="card-body">
                          <h4 class="card-title"> 일시 : 2020. 9. 10</h4>
                          프로그래머만 알아듣는 유머. 비유... 
                          그리고 함께겪는 어려움과 기쁨을 함께하는 공감과 소통의 장에 초대합니다.
                      </div>
                  </div>
                </div>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="card">
                        <div class="card-header card-header-icon card-header-primary">
                          <div class="card-icon">
                            <i class="material-icons">groups</i> &nbsp;&nbsp;&nbsp;모각코
                          </div>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title"> 일시 : 2020. 9. 10</h4>
  ...
  <footer class="footer" data-background-color="black">
    <div class="container">
      ...
      <div class="copyright float-right">
        ...
        <a href="https://www.creative-tim.com/" target="_blank">Magpies</a> for a better web.
      </div>
    </div>
  </footer>
  <!--   Core JS Files   -->
